...
const dict = {
  ...
  fld_product_name: { ar: "اسم المنتج (العنوان)", en: "Product name (title)" },
  fld_description: { ar: "الوصف", en: "Description" },
  fld_image: { ar: "الصورة", en: "Image" },
  fld_image_url_ph: { ar: "الصق رابط صورة…", en: "Paste an image URL…" },
  fld_variant: { ar: "التنويعة (مقاس/لون)", en: "Variant (size / color)" },
  fld_variants_options: { ar: "التنويعات (الخيارات)", en: "Variants (options)" },
  fld_option_name_ph: { ar: "اسم الخيار (المقاس، اللون…)", en: "Option name (Size, Color…)" },
  fld_value_ph: { ar: "أضف قيمة ثم Enter", en: "Add a value, press Enter" },
  ...
  st_archived: { ar: "مؤرشف", en: "Archived" },
  status_label: { ar: "الحالة", en: "Status" },

  sec_details: { ar: "التفاصيل", en: "Details" },
  sec_media: { ar: "الوسائط", en: "Media" },
  sec_pricing: { ar: "التسعير", en: "Pricing" },
  sec_variants2: { ar: "التنويعات", en: "Variants" },
  sec_inventory: { ar: "المخزون", en: "Inventory" },
  sec_organization: { ar: "التصنيف", en: "Organization" },
  sec_recommendations: { ar: "توصيات", en: "Recommendations" },

  fld_compare_at: { ar: "السعر قبل الخصم", en: "Compare-at price" },
  fld_compare_at_hint: { ar: "يظهر مشطوباً بجانب السعر لإبراز التخفيض.", en: "Shown struck-through next to the price to signal a sale." },
  fld_cost_hint: { ar: "لا يظهر للعملاء؛ يُستخدم لحساب الربح.", en: "Not shown to customers; used to compute profit." },
  profit_label: { ar: "الربح", en: "Profit" },
  margin_label: { ar: "هامش الربح", en: "Margin" },

  fld_vendor: { ar: "المورّد / العلامة", en: "Vendor" },
  fld_product_type: { ar: "نوع المنتج", en: "Product type" },
  fld_tags: { ar: "الوسوم", en: "Tags" },
  fld_tags_ph: { ar: "أضف وسماً ثم Enter", en: "Add a tag, press Enter" },

  media_add: { ar: "إضافة صورة برابط", en: "Add image by URL" },
  media_primary: { ar: "رئيسية", en: "Primary" },
  media_hint: { ar: "أول صورة هي الصورة الرئيسية. الصق روابط الصور.", en: "First image is the primary. Paste image URLs." },
  generate_sku: { ar: "توليد", en: "Generate" },
  variant_col: { ar: "التنويعة", en: "Variant" },
  discard_changes: { ar: "تجاهل التغييرات؟", en: "Discard changes?" },

  // ---- Inventory dashboard (KPIs, filters, sorting) ----
  kpi_products: { ar: "المنتجات", en: "Products" },
  kpi_variants: { ar: "التنويعات", en: "Variants" },
  kpi_units: { ar: "الوحدات بالمخزون", en: "Units in stock" },
  kpi_value: { ar: "قيمة المخزون", en: "Inventory value" },
  kpi_low_stock: { ar: "مخزون منخفض", en: "Low stock" },
  kpi_out_stock: { ar: "نفد المخزون", en: "Out of stock" },

  filter_status: { ar: "الحالة", en: "Status" },
  filter_stock: { ar: "المخزون", en: "Stock" },
  filter_category: { ar: "الفئة", en: "Category" },
  all_categories: { ar: "كل الفئات", en: "All categories" },
  ...
  sort_avail_low: { ar: "الأقل مخزوناً", en: "Least available" },
  sort_price_high: { ar: "الأعلى سعراً", en: "Price high → low" },
  sort_price_low: { ar: "الأقل سعراً", en: "Price low → high" },
  sort_updated: { ar: "آخر تحديث", en: "Recently updated" },
  col_vendor: { ar: "المورّد", en: "Vendor" },
